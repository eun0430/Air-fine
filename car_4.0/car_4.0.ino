...
const char* ssid = "U+NetCC94_5G";
const char* password = "2F5E2K2FB$";
//const char* mqtt_server = "broker.emqx.io";
//const char* ssid = "olleh_WiFi_EE39";
//const char* password = "0000002274";
...
char *control = "hywu/carry/1";              // callback topic
char *route = "hywu/route/1";

/*
 for car
 */
int onestep = 2500;                // 두칸 기준으로 맞춘거임
...
#define MHIGH       105     // analogwrite duty 0~255    바꿀 수 있는 값
...
volatile const byte interruptInPin = 34;
volatile byte interruptOutPin = 19;
char key = 'A';
...
void setup(){
  ...
  // interrupt
  pinMode(interruptInPin, INPUT);
  pinMode(interruptOutPin, OUTPUT);
  digitalWrite(interruptOutPin, LOW);

  attachInterrupt(digitalPinToInterrupt(interruptInPin), controlK, RISING);
